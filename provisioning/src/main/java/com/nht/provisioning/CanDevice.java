...
import com.nht.provisioning.listeners.WiFiScanListener;
import com.nht.provisioning.security.Security;
import com.nht.provisioning.security.Security0;
import com.nht.provisioning.security.Security1;
import com.nht.provisioning.security.Security2;
import com.nht.provisioning.transport.BLETransport;
import com.nht.provisioning.transport.SoftAPTransport;
import com.nht.provisioning.transport.Transport;
import com.nht.provisioning.utils.MessengeHelper;
...
/**
 * CanDevice class to hold device information. This will give facility to connect device, send data to device and
 * do provisioning of it.
 */
public class CanDevice {

    private static final String TAG = "ESP:" + CanDevice.class.getSimpleName();
    ...
    private CanConstants.TransportType transportType;
    private CanConstants.SecurityType securityType;
    ...
    public CanDevice(Context context, CanConstants.TransportType transportType, CanConstants.SecurityType securityType) {
    ...
    /**
     * This method is used to connect CanDevice.
     */
    ...
    /**
     * This method is used to connect CanDevice using BLE transport.
     *
    ...
    public void connectBLEDevice(BluetoothDevice bluetoothDevice, String primaryServiceUuid) {
        ...
        if (transport instanceof BLETransport) {
            ...
            EventBus.getDefault().post(new DeviceConnectionEvent(CanConstants.EVENT_DEVICE_CONNECTION_FAILED));
        }
    }

    /**
     * This method is used to connect CanDevice using Wi-Fi transport.
     */
    ...
    /**
     * This method is used to disconnect CanDevice.
     ...
     */
    public CanConstants.TransportType getTransportType() {
     ...
     */
    public CanConstants.SecurityType getSecurityType() {
        return securityType;
    }
     ...
     * @return Returns security type.
     */
    public void setSecurityType(CanConstants.SecurityType secType) {
    ...
    public void resetWifiStatus(final ResponseListener listener) {
        ...
        session.sendDataToDevice(CanConstants.HANDLER_PROV_CTRL, resetCommand, new ResponseListener() {
    ...
    public void initSession(final ResponseListener listener) {
        ...
        try {
            ...
            if (provInfo.has("sec_ver")) {
                ...
                switch (serVer) {
                    case 0:
                        securityType = CanConstants.SecurityType.SECURITY_0;
                        break;
                    case 1:
                        securityType = CanConstants.SecurityType.SECURITY_1;
                        break;
                    case 2:
                    default:
                        securityType = CanConstants.SecurityType.SECURITY_2;
                ...
                if (securityType == CanConstants.SecurityType.SECURITY_2) {
                    securityType = CanConstants.SecurityType.SECURITY_1;
                }
            }
    ...
    private void startNetworkScan() {
        ...
        session.sendDataToDevice(CanConstants.HANDLER_PROV_SCAN, scanCommand, new ResponseListener() {
            ...
            public void onSuccess(byte[] returnData) {
                ...
                session.sendDataToDevice(CanConstants.HANDLER_PROV_SCAN, getScanStatusCmd, new ResponseListener() {
    ...
    private void getWiFiScanList(int start, int count) {
        ...
        session.sendDataToDevice(CanConstants.HANDLER_PROV_SCAN, data, new ResponseListener() {
    ...
    private void sendWiFiConfig(final String ssid, final String passphrase, final ProvisionListener provisionListener) {
        ...
        session.sendDataToDevice(CanConstants.HANDLER_PROV_CONFIG, scanCommand, new ResponseListener() {
    ...
    private void pollForWifiConnectionStatus() {
        ...
        session.sendDataToDevice(CanConstants.HANDLER_PROV_CONFIG, message, new ResponseListener() {
            ...
            public void onSuccess(byte[] returnData) {
                ...
                if (wifiStationState == NetworkConstants.WifiStationState.Connected) {
                    ...
                    if (provisionListener != null) {
                        provisionListener.provisioningFailedFromDevice(CanConstants.ProvisionFailureReason.DEVICE_DISCONNECTED);
                    }
                    disableOnlyWifiNetwork();
                    ...
                    if (failedReason == NetworkConstants.WifiConnectFailedReason.AuthError) {
                        ...
                        provisionListener.provisioningFailedFromDevice(CanConstants.ProvisionFailureReason.AUTH_FAILED);

                    } else if (failedReason == NetworkConstants.WifiConnectFailedReason.WifiNetworkNotFound) {

                        provisionListener.provisioningFailedFromDevice(CanConstants.ProvisionFailureReason.NETWORK_NOT_FOUND);

                    } else {
                        provisionListener.provisioningFailedFromDevice(CanConstants.ProvisionFailureReason.UNKNOWN);
                    }
                    disableOnlyWifiNetwork();
                }
            }
    ...
    private Runnable getCapabilitiesTask = new Runnable() {
        ...
        public void run() {
            ...
            transport.sendConfigData(CanConstants.HANDLER_PROTO_VER, tempData.getBytes(), new ResponseListener() {
                ...
                public void onSuccess(byte[] returnData) {
                    ...
                    EventBus.getDefault().post(new DeviceConnectionEvent(CanConstants.EVENT_DEVICE_CONNECTED));
                }
