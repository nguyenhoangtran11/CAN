...
package com.nht.provisioning.transport;
    ...
    private BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                EventBus.getDefault().post(new DeviceConnectionEvent(CanConstants.EVENT_DEVICE_DISCONNECTED));
            }
        }
...
//                return;
            ...
            if (isReadingDescriptors) {
                ...
                BluetoothGattCharacteristic characteristic = service.getCharacteristic(UUID.fromString(uuidMap.get(CanConstants.HANDLER_PROTO_VER)));
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (uuidMap.get((CanConstants.HANDLER_PROTO_VER)).equals(characteristic.getUuid().toString())) {
        ...
        for (int i = 0; i < charUuidList.size(); i++) {
            ...
            if (!uuidMap.containsValue(uuid)) {
                ...
                for (BluetoothGattDescriptor descriptor : characteristic.getDescriptors()) {
                    ...
                    if (desUuid.contains(CanConstants.USER_DESCRIPTION_UUID)) {
