...
import com.nht.ui.adapters.WiFiListAdapter
import com.nht.wifi_provisioning.R
import com.nht.wifi_provisioning.databinding.ActivityWifiScanListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.layoutWifiList.wifiApList.onItemClickListener =
            OnItemClickListener { adapterView, view, pos, l ->
                ...
                } else if (wifiAPList[pos].security == CanConstants.WIFI_OPEN.toInt()) {
            ...
            buttonPositive.setOnClickListener {
                ...
                if (ssid == getString(R.string.join_other_network)) {
                    ...
                    if (TextUtils.isEmpty(password)) {
                        if (authMode != CanConstants.WIFI_OPEN.toInt()) {
                            val passwordLayout =
