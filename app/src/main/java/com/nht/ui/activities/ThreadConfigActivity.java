...
import com.nht.provisioning.WiFiAccessPoint;
import com.nht.provisioning.listeners.WiFiScanListener;
import com.nht.ui.utils.Utils;
import com.nht.wifi_provisioning.R;
import com.nht.wifi_provisioning.databinding.ActivityThreadScanListBinding;
...
public class ThreadConfigActivity extends AppCompatActivity {
    ...
    private CanProvisionManager provisionManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        provisionManager = CanProvisionManager.getInstance(getApplicationContext());
    ...
    public void onEvent(DeviceConnectionEvent event) {
        ...
        if (event.getEventType() == CanConstants.EVENT_DEVICE_DISCONNECTED) {
            if (!isFinishing()) {
