...
class CanMainActivity : AppCompatActivity() {
    ...
    private fun gotoQrCodeActivity() {
        val intent = Intent(this@CanMainActivity, AddDeviceActivity::class.java)
        startActivity(intent)
    }

    private fun goToBLEProvisionLandingActivity(securityType: Int) {
        val intent = Intent(this@CanMainActivity, BLEProvisionLanding::class.java)
        intent.putExtra(AppConstants.KEY_SECURITY_TYPE, securityType)
        startActivity(intent)
    }

    private fun goToWiFiProvisionLandingActivity(securityType: Int) {
        val intent = Intent(this@CanMainActivity, ProvisionLanding::class.java)
        intent.putExtra(AppConstants.KEY_SECURITY_TYPE, securityType)
        startActivity(intent)
    }
}
